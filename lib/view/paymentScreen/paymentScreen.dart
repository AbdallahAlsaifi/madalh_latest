...
class MaleBundleScreen extends StatefulWidget {
  final bool isError;
  ...
  @override
  State<MaleBundleScreen> createState() => _MaleBundleScreenState();
}

class _MaleBundleScreenState extends State<MaleBundleScreen> {
  ...
  bool isError = false;
  getData() async {
    var snap = await _firestore.collection('AppSettings').doc('Bundles').get();
    setState(() {
                  ...
                  AnimatedTextKit(
                    ...
                    animatedTexts: [
                      TypewriterAnimatedText(
                        'عزيزي المستخدم لتستطيع التقديم على الملفات حيث يتجاوز التطابق فيها 65% يجب عليك الإشتراك بالباقة',
                        ...
                        children: [
                          Container(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                constants.smallText(' تطابقات ', context,
                                    color: Colors.redAccent),
                                constants.smallText(
                                    BundleData['bundle${index + 1}']['matches']
                                        .toString(),
                                    color: Colors.redAccent,
                                    context),
                              ],
                                          ...
                                          PaypalCheckout(
                                            ...
                                            onSuccess: (Map params) async {
                                              ...
                                              await FirebaseFirestore.instance
                                                  ...
                                                  .update({
                                                'matches': BundleData['bundle${index + 1}']['matches'],
                                                'isSubscribed': true,
                                                'subscriptionDate': DateTime.now(),
                                                'bundleMatches': BundleData['bundle${index + 1}']['matches'],
                                              });
                                              _successDialog(context);
                                            },
                                            onError: (error) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<PaymentNotifier>(builder: (__, data, _) {
